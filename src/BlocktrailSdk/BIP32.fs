 ...
 */
*)
let bitcoin_mainnet_public = "0488b21e";
let bitcoin_mainnet_private = "0488ade4";
let bitcoin_mainnet_version = "00";
let bitcoin_testnet_public = "043587cf";
let bitcoin_testnet_private = "04358394";
let bitcoin_testnet_version = "6f";

/// Master Key
///
/// This function accepts a hex string as a seed; and allows you to
/// select testnet extended keys.
///
...
/// @return    string
let master_key seed testnet : string =
        (*
...
/// @return    array
let CKD (master : string) (address_definition : string list) generated =
    (*
    {
